...
namespace FinancialPortfolio.Business.Validators.Etf
{
    public class EtfUpdateRequestValidator : AbstractValidator<EtfUpdateRequest>
    {
        public EtfUpdateRequestValidator()
        {
            RuleFor(x => x.Symbol)
                .NotEmpty()
