...
{
    public class PayRdInstallmentRequestValidator : AbstractValidator<PayRdInstallmentRequest>
    {
        public PayRdInstallmentRequestValidator()
        {
            RuleFor(x => x.InstallmentNumber).GreaterThan(0).When(x => x.InstallmentNumber.HasValue);
