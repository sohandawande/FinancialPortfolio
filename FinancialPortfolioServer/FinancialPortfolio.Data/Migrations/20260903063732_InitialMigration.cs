...
namespace FinancialPortfolio.Data.Migrations
{
    ...
    public partial class InitialMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "PortfolioInsurancePolicies",
                columns: table => new
                {
                    Id = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    PortfolioId = table.Column<long>(type: "bigint", nullable: false),
                    InsurerName = table.Column<string>(type: "nvarchar(120)", maxLength: 120, nullable: false),
                    ...
                    PremiumPayingTermYears = table.Column<int>(type: "int", nullable: false),
                    PolicyTermYears = table.Column<int>(type: "int", nullable: false),
                    StartDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    MaturityDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    PremiumsPaid = table.Column<int>(type: "int", nullable: false),
                    ExpectedMaturityAmount = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: true),
                    Status = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    Notes = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true),
                    CreatedBy = table.Column<long>(type: "bigint", nullable: true),
                    ModifiedBy = table.Column<long>(type: "bigint", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PortfolioInsurancePolicies", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PortfolioInsurancePolicies_Portfolios_PortfolioId",
                        column: x => x.PortfolioId,
                        principalTable: "Portfolios",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PortfolioInsurancePolicies_PortfolioId",
                table: "PortfolioInsurancePolicies",
                column: "PortfolioId");

            migrationBuilder.CreateIndex(
                name: "IX_PortfolioInsurancePolicies_PortfolioId_PolicyNumber",
                table: "PortfolioInsurancePolicies",
                columns: new[] { "PortfolioId", "PolicyNumber" },
                unique: true);
