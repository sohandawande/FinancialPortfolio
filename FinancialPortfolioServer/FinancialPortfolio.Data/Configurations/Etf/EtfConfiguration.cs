namespace FinancialPortfolio.Data.Configurations.Etf
{
    ...
    /// <summary>
    /// Defines the <see cref="EtfConfiguration" />
    /// </summary>
    public class EtfConfiguration : IEntityTypeConfiguration<EtfEntity>
    {
        /// <summary>
        /// The Configure
        /// </summary>
        /// <param name="builder">The builder<see cref="EntityTypeBuilder{EtfEntity}"/></param>
        public void Configure(EntityTypeBuilder<EtfEntity> builder)
        {
            // Table Mapping
