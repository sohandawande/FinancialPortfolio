namespace FinancialPortfolio.Data.Configurations.Stock
{
    ...
    /// <summary>
    /// Defines the <see cref="StockDetailConfiguration" />
    /// </summary>
    public sealed class StockDetailConfiguration : IEntityTypeConfiguration<StockDetailEntity>
    {
        /// <summary>
        /// The Configure
        /// </summary>
        /// <param name="builder">The builder<see cref="EntityTypeBuilder{StockDetailEntity}"/></param>
        public void Configure(EntityTypeBuilder<StockDetailEntity> builder)
        {
            // Table Mapping
            ...
            builder.HasOne(sd => sd.Stock)
                   .WithOne(s => s.StockDetail)
                   .HasForeignKey<StockDetailEntity>(sd => sd.StockId)
